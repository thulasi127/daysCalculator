...
int day_of_leapYear[12] = {1, 32, 61, 92, 122, 153, 183, 214, 245, 275, 306, 336};
   ...
   if ( argc < 3 || argc > 4 ) {
      ...
      exit (1);
    } if ((strcmp("today",argv[1]) == 0) && (strcmp("today",argv[2]) == 0)) {
      dd1 = local->tm_mday;
      mm1 = local->tm_mon + 1;
...
if (((yyyy1%400 == 0 || yyyy1%100 > 0) && (yyyy1%4 == 0)) && ((mm1 == 2) && (dd1 < 1 || dd1>29)) || ((mm2 == 2) && (dd2<1 || dd2>29))) {
  printf("Error - the day is not in this month\n");
  return (1);
}
